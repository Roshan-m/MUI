...
// in simulator we redefine to format for k1503_MUI_Mykoo_Roshan Developer console
...
{\
	NSString * exceptionName = [@"org.k1503_mui_mykoo_roshan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1503_mui_mykoo_roshan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1503_MUI_Mykoo_RoshanNativeItemNone = -1, 
	UIk1503_MUI_Mykoo_RoshanNativeItemSpinner = -2,
	UIk1503_MUI_Mykoo_RoshanNativeItemProgressBar = -3,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemSlider = -4,
	UIk1503_MUI_Mykoo_RoshanNativeItemSwitch = -5,
	UIk1503_MUI_Mykoo_RoshanNativeItemMultiButton = -6,
	UIk1503_MUI_Mykoo_RoshanNativeItemSegmented = -7,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemTextView = -8,
	UIk1503_MUI_Mykoo_RoshanNativeItemTextField = -9,
	UIk1503_MUI_Mykoo_RoshanNativeItemSearchBar = -10,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemPicker = -11,
	UIk1503_MUI_Mykoo_RoshanNativeItemDatePicker = -12,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemInfoLight = -13,
	UIk1503_MUI_Mykoo_RoshanNativeItemInfoDark = -14,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemDisclosure = -15,
	
	UIk1503_MUI_Mykoo_RoshanNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1503_MUI_Mykoo_Roshan instances of
