...
@interface k1503_MUI_Mykoo_RoshanObject : KrollCoverageObject {
#else
@interface k1503_MUI_Mykoo_RoshanObject : KrollObject {
#endif
@private
...
extern NSString * k1503_MUI_Mykoo_Roshan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1503_MUI_Mykoo_RoshanObject *_k1503_mui_mykoo_roshan;
    KrollObject* console;
	BOOL shutdown;
