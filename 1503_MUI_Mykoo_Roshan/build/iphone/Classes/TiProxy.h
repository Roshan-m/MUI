...
//Rare exceptions to indicate a bug in the _k1503_mui_mykoo_roshan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1503_MUI_Mykoo_Roshan proxies.
 */
