...
/**
 Base class for all k1503_MUI_Mykoo_Roshan views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1503_MUI_Mykoo_Roshan view hierarchy (such as wrapped iOS UIViews) was touched.
