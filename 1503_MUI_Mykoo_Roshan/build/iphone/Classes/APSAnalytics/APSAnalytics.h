 ...
 * to send analytic data that can be viewed on the k1503_MUI_Mykoo_Roshan Dashboard.
 *
 * For information on getting started with k1503_MUI_Mykoo_Roshan Platform Services,
