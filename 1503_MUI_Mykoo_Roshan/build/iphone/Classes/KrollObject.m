...
//@interface k1503_MUI_Mykoo_RoshanObject : NSObject
//@end

@interface k1503_MUI_Mykoo_RoshanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1503_MUI_Mykoo_RoshanObject class]])
		{
			for (NSString *key in [[(k1503_MUI_Mykoo_RoshanObject*)o modules] allKeys])
			{
