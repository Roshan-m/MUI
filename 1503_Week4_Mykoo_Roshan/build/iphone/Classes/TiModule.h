...
/**
 The base class for all k1503_Week4_Mykoo_Roshan modules
 */
...
/**
 k1503_Week4_Mykoo_Roshan Platform calls this method on startup.
 */
-(void)startup;

/**
 k1503_Week4_Mykoo_Roshan Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k1503_Week4_Mykoo_Roshan Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k1503_Week4_Mykoo_Roshan Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k1503_Week4_Mykoo_Roshan Platform calls this method on resume.
 @param sender The sender of the event.
 */
