...
@interface k1503_Week4_Mykoo_RoshanObject : KrollCoverageObject {
#else
@interface k1503_Week4_Mykoo_RoshanObject : KrollObject {
#endif
@private
...
extern NSString * k1503_Week4_Mykoo_Roshan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1503_Week4_Mykoo_RoshanObject *_k1503_week4_mykoo_roshan;
    KrollObject* console;
	BOOL shutdown;
