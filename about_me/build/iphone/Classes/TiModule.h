...
/**
 The base class for all about_me modules
 */
...
/**
 about_me Platform calls this method on startup.
 */
-(void)startup;

/**
 about_me Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 about_me Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 about_me Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 about_me Platform calls this method on resume.
 @param sender The sender of the event.
 */
