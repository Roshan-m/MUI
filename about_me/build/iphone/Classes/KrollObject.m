...
//@interface about_meObject : NSObject
//@end

@interface about_meObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[about_meObject class]])
		{
			for (NSString *key in [[(about_meObject*)o modules] allKeys])
			{
