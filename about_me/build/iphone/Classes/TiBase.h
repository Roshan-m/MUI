...
// in simulator we redefine to format for about_me Developer console
...
{\
	NSString * exceptionName = [@"org.about_me." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.about_me";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIabout_meNativeItemNone = -1, 
	UIabout_meNativeItemSpinner = -2,
	UIabout_meNativeItemProgressBar = -3,
	
	UIabout_meNativeItemSlider = -4,
	UIabout_meNativeItemSwitch = -5,
	UIabout_meNativeItemMultiButton = -6,
	UIabout_meNativeItemSegmented = -7,
	
	UIabout_meNativeItemTextView = -8,
	UIabout_meNativeItemTextField = -9,
	UIabout_meNativeItemSearchBar = -10,
	
	UIabout_meNativeItemPicker = -11,
	UIabout_meNativeItemDatePicker = -12,
	
	UIabout_meNativeItemInfoLight = -13,
	UIabout_meNativeItemInfoDark = -14,
	
	UIabout_meNativeItemDisclosure = -15,
	
	UIabout_meNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all about_me instances of
